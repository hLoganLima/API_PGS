...
def fetch_produto_data_row_by_row(supabase_url, supabase_key):
    ...
    while True:
        ...
        try:
            ...
            if response.data:
                ...
                print("Todos os registros da tabela 'produto' foram processados.")
                break
    ...
    if all_data:
        ...
        json_path = os.path.join(data_dir, "data_produto_supabase.json")
        ...
        print("Nenhum dado encontrado na tabela 'produto'.")
        return None
